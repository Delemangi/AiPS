...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    public int getHeight(E a) {
        return getHeightRecursive(find(a));
    }

    private int getHeightRecursive(BNode<E> node) {
        if (node == null) {
            return 0;
        }
    ...
    private int getNodesAtDepthRecursive(BNode<E> node, int depth, int i) {
        if (node == null) {
            return 0;
        }
        ...
        return getNodesAtDepthRecursive(node.left, depth, i + 1) + getNodesAtDepthRecursive(node.right, depth, i + 1);
    }
}